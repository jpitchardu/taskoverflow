...
"[project]/src/hooks/tasks.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useTasks() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tanstack$2b$react$2d$query$40$5$2e$83$2e$0_react$40$19$2e$1$2e$0$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useTasks.useQuery": async ()=>{
                const response = await fetch("".concat(API_URL, "/tasks"));
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tanstack$2b$react$2d$query$40$5$2e$83$2e$0_react$40$19$2e$1$2e$0$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useTask.useQuery": async ()=>{
                const response = await fetch("".concat(API_URL, "/tasks/").concat(id));
                const data = await response.json();
                return data.task;
            }
        }["useTask.useQuery"]
...
function useCreateTask() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tanstack$2b$react$2d$query$40$5$2e$83$2e$0_react$40$19$2e$1$2e$0$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useCreateTask.useMutation": async (task)=>{
                const response = await fetch("".concat(API_URL, "/tasks"), {
                    method: "POST",
...
function useUpdateTask() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$tanstack$2b$react$2d$query$40$5$2e$83$2e$0_react$40$19$2e$1$2e$0$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useUpdateTask.useMutation": async (task)=>{
                const response = await fetch("".concat(API_URL, "/tasks/").concat(task.id), {
                    method: "PATCH",
                    body: JSON.stringify(task)
                });
                if (!response.ok) {
...
"[project]/src/components/TaskComposer.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$tasks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/tasks.ts [app-client] (ecmascript)");
...
function TaskComposer() {
    _s();
    const { mutate: createTask } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$tasks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCreateTask"])();
...
_s(TaskComposer, "URpCI6SfcKULqlz86lq0XopHnjs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$tasks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCreateTask"]
    ];
});
_c = TaskComposer;
var _c;
__turbopack_context__.k.register(_c, "TaskComposer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_d0d4bbbb._.js.map